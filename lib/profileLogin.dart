...
import 'exploreeeeeLogin.dart';
import 'navbar.dart'; // Import the navbar

void main() {
  runApp(const ProfileAppLogin());
}

class ProfileAppLogin extends StatelessWidget {
  const ProfileAppLogin({super.key});
            ...
            child: Align(
              ...
              child: ElevatedButton.icon(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const ExploreeeePageLogin()),
                  );
                },
